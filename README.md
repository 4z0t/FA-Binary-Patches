...
| -------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | ---------------------------------------- |
| Custom World Rendering                 | Adds Custom World Rendering functions:                                                                                                                | DrawFunc.cpp                                             | HDraw.cpp                                |
|                                        | - `UI_DrawRect(pos:vector, size:float, color:string, thickness?=0.15:float)`                                                                          | DrawCircleSetColor.cpp                                   | GetFPS.cpp                               |
