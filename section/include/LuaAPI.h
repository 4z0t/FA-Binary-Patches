 ...
 namespace CLuaObject
  {
    ...
    //public
      ...
      FDecl(0x908a70, CLuaObject5, __thiscall LuaObject (*)(LuaObject* this_, LuaStackObject*))
      ...
      FDecl(0x90a180, Clone, __thiscall LuaObject* (*)(LuaObject* this_, LuaObject* dest))
