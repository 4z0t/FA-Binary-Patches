...
FDecl(0x90d400, lua_call, int __cdecl (*)(lua_State*, int, int))
...
FDecl(0x90d000, lua_gettable, int __cdecl (*)(lua_State*, int))
...
FDecl(0x90cdf0, lua_pushstring, int __cdecl (*)(lua_State*, const char*))
FDecl(0x90c6e0, lua_pushvalue, void __cdecl (*)(lua_State*, int))
FDecl(0x90d050, lua_rawget, int __cdecl (*)(lua_State*, int))
